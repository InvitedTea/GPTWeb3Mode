...
login_button_erc721 = wallet_connect(label="login", key="login", message="Connect Your Wallet to Validate Your NFT badge", auth_token_contract_address="0x967da4048cD07aB37855c090aAF366e4ce1b9F48", chain_name="MODE_TEST", RPC_URL='https://sepolia.mode.network', contract_type="ERC721", num_tokens="0")

st.write('This Demo USE MODE NFT MODE')
